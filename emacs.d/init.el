...
(custom-set-variables
 ...
 '(magit-commit-arguments (quote ("--gpg-sign=8AAB27522925829E")))
 '(package-selected-packages
   (quote
    (markdown-mode use-package flow-minor-mode auto-complete exec-path-from-shell helm-ag js2-mode escreen prettier-js flycheck base16-theme key-chord evil-magit magit helm-projectile evil-leader helm evil))))
